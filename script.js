...
form.addEventListener('submit',(event) =>{
    ...
    console.log('E-mail id is: ',mail.value);
    console.log('Phone number is: ',number.value);
    console.log('BITS-ID is: ',id.value);
    }
})
...
if(numberVal === ""){
    ...
    setErrormsg(number,'Please enter 10 digit number only')
}
else{
